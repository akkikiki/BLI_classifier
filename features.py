...
class EditDistance(object):
  def __init__(self, vocabulary_source, vocabulary_target, edit_distance_matrix_file):
    ...
    self._edit_distance_matrix = self.get_edit_distance_matrix()
  ...
  def get_edit_distance_matrix(self):
    ...
    if path.exists(edit_distance_matrix_file):
      return np.load(edit_distance_matrix_file)
